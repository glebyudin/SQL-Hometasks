...
values ('Русский'), ('Испанский'), ('Китайский'), ('Арабский'), ('Иврит');
...
values ('Русские'), ('Аргентинцы'), ('Китайцы'), ('Алжирцы'), ('Евреи');

--СОЗДАНИЕ ТАБЛИЦЫ СТРАНЫ
CREATE TABLE country(country_id serial NOT null PRIMARY KEY,
country_name VARCHAR (50) UNIQUE NOT NULL);

--ВНЕСЕНИЕ ДАННЫХ В ТАБЛИЦУ СТРАНЫ
INSERT INTO country(country_name)
values ('Россия'), ('Аргентина'), ('Китай'), ('Алжир'), ('Израиль');
...
nationality_id integer not null generated always as identity,
...
INSERT INTO lang_nation(nationality_id,language_id)
